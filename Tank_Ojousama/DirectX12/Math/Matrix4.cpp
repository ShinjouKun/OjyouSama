...
Vector3 & operator*=(Vector3 & v, const Matrix4 & matrix)
{
	Vector3 tenp(0, 0, 0);
	tenp.x = v.x*matrix.m[0][0] + v.y * matrix.m[1][0] + v.z * matrix.m[2][0] + matrix.m[3][0];
	tenp.y = v.x*matrix.m[0][1] + v.y * matrix.m[1][1] + v.z * matrix.m[2][1] + matrix.m[3][1];
	tenp.z = v.x*matrix.m[0][2] + v.y * matrix.m[1][2] + v.z * matrix.m[2][2] + matrix.m[3][2];
