...
void Result::DrawScene()
{
	...
	BaseScene::mModel->Draw("ArmR", Vector3(0,3.2f,0 ), Vector3(0, 0, 0), Vector3(1.5f, 1.5f, 1.5f));
	BaseScene::mModel->Draw("OjyouSama", Vector3(0,0,0 ), Vector3(0, 0, 0), Vector3(1.5f, 1.5f, 1.5f));
	BaseScene::mModel->Draw("ArmL", Vector3(0,3.2f,0 ), Vector3(0, 0, 0), Vector3(1.5f, 1.5f, 1.5f));
