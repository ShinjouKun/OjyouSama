...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	//重戦車
	ModelLoader::GetInstance(pipeLine)->Load("Resouse/big_sensha_body.obj");//車体
	ModelLoader::GetInstance(pipeLine)->Load("Resouse/big_sensha_head.obj");//砲塔
	//ゴーレム
	ModelLoader::GetInstance(pipeLine)->Load("Resouse/gorem_body.obj");//車体
	ModelLoader::GetInstance(pipeLine)->Load("Resouse/gorem_hands_L.obj");//車体
	ModelLoader::GetInstance(pipeLine)->Load("Resouse/gorem_hands_R.obj");//車体
	//当たり判定用の円
